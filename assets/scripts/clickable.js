(function() {
    ...
    var gooseIdle = PIXI.Texture.from('assets/scripts/idle.png');
    var gooseHurt = PIXI.Texture.from('assets/scripts/hurt.png');
    var gooseAngry = PIXI.Texture.from('assets/scripts/angry.png');
